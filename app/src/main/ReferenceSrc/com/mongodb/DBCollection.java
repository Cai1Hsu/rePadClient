...
public abstract class DBCollection {
    ...
    public abstract QueryResultIterator find(DBObject dBObject, DBObject dBObject2, int i, int i2, int i3, int i4, ReadPreference readPreference, DBDecoder dBDecoder);

    public abstract QueryResultIterator find(DBObject dBObject, DBObject dBObject2, int i, int i2, int i3, int i4, ReadPreference readPreference, DBDecoder dBDecoder, DBEncoder dBEncoder);
    ...
    public DBObject defaultOptions(DBObject keys) {
    ...
    public DBObject findOne(DBObject o, DBObject fields, DBObject orderBy, ReadPreference readPref, long maxTime, TimeUnit maxTimeUnit) {
    ...
    public long getCount(DBObject query, DBObject fields, long limit, long skip, ReadPreference readPrefs, long maxTime, TimeUnit maxTimeUnit) {
    ...
    public BulkWriteResult executeBulkWriteOperation(boolean ordered, List<WriteRequest> requests) {
        return executeBulkWriteOperation(ordered, requests, getWriteConcern());
    }

    public BulkWriteResult executeBulkWriteOperation(boolean ordered, List<WriteRequest> requests, WriteConcern writeConcern) {
        return executeBulkWriteOperation(ordered, requests, writeConcern, getDBEncoder());
    }

    public DBObject prepareCommand(List<DBObject> pipeline, AggregationOptions options) {
        if (pipeline.isEmpty()) {
