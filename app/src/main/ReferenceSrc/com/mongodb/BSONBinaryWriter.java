...
class BSONBinaryWriter extends BSONWriter {
    ...
    static /* synthetic */ OutputBuffer access$200(BSONBinaryWriter x0) {
        return x0.buffer;
    }
    ...
    private void backpatchSize() {
        int size = this.buffer.getPosition() - Context.access$100(getContext());
    ...
    private void throwIfSizeExceedsLimit(int size) {
        if (size > this.maxDocumentSizeStack.peek().intValue()) {
            String message = String.format("Size %d is larger than MaxDocumentSize %d.", Integer.valueOf(this.buffer.getPosition() - Context.access$100(getContext())), Integer.valueOf(this.binaryWriterSettings.getMaxDocumentSize()));
    ...
    class Context extends BSONWriter.Context {
        ...
        static /* synthetic */ int access$100(Context x0) {
            return x0.startPosition;
        }
    ...
    class Mark extends BSONWriter.Mark {
        ...
        protected Mark() {
            super();
            BSONBinaryWriter.this = r2;
            this.position = BSONBinaryWriter.access$200(r2).getPosition();
        }

        @Override // com.mongodb.BSONWriter.Mark
        public void reset() {
            super.reset();
            BSONBinaryWriter.access$200(BSONBinaryWriter.this).truncateToPosition(BSONBinaryWriter.access$300(BSONBinaryWriter.this).position);
        }
    }
}
