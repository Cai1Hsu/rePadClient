...
class QueryResultIterator implements Cursor {
    ...
    static /* synthetic */ boolean access$100(QueryResultIterator x0) {
        return x0.closed;
    }

    static /* synthetic */ long access$200(QueryResultIterator x0) {
        return x0._cursorId;
    }

    static /* synthetic */ ServerAddress access$300(QueryResultIterator x0) {
        return x0._host;
    }

    static /* synthetic */ DBApiLayer access$400(QueryResultIterator x0) {
        return x0._db;
    }

    public QueryResultIterator(DBApiLayer db, DBCollectionImpl collection, Response res, int batchSize, int limit, int options, DBDecoder decoder) {
    ...
    public QueryResultIterator(DBObject cursorDocument, DBApiLayer db, DBCollectionImpl collection, int batchSize, DBDecoder decoder, ServerAddress serverAddress) {
        this._sizes = new ArrayList();
        this._numGetMores = 0;
        this._numFetched = 0;
        this._db = db;
    ...
    public static int chooseBatchSize(int batchSize, int limit, int fetched) {
        int res;
    ...
    private OptionalFinalizer getOptionalFinalizer(DBCollectionImpl coll) {
        ...
        return new OptionalFinalizer(this, null);
    }
    ...
    private class OptionalFinalizer {
        ...
        /* synthetic */ OptionalFinalizer(QueryResultIterator x0, AnonymousClass1 x1) {
            this();
        }

        protected void finalize() throws Throwable {
            if (!QueryResultIterator.access$100(QueryResultIterator.this) && QueryResultIterator.access$200(QueryResultIterator.this) != 0) {
                QueryResultIterator.access$400(QueryResultIterator.this).addDeadCursor(new DBApiLayer.DeadCursor(QueryResultIterator.access$200(QueryResultIterator.this), QueryResultIterator.access$300(QueryResultIterator.this)));
            }
            super.finalize();
        }
    }
