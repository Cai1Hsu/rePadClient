...
class BulkWriteBatchCombiner {
    ...
    private final Set<BulkWriteUpsert> writeUpserts = new TreeSet(new Comparator<BulkWriteUpsert>() { // from class: com.mongodb.BulkWriteBatchCombiner.1
    ...
    private final Set<BulkWriteError> writeErrors = new TreeSet(new Comparator<BulkWriteError>() { // from class: com.mongodb.BulkWriteBatchCombiner.2
