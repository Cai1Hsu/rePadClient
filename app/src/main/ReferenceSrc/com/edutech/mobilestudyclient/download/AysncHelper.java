...
/* loaded from: classes.jar:com/edutech/mobilestudyclient/download/AysncHelper.class */
public class AysncHelper {
    ...
    public static void startDownLoadList(ArrayList<HashMap<String, String>> arrayList, ArrayList<Map<String, Async>> arrayList2) {
        boolean z;
        Log.d("wpdemo", "downloadlist = " + arrayList.size());
        Log.d("wpdemo", "downloadlist = " + arrayList.toString());
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            Log.d("wpdemo", "add 下载连接的个数 listTask.size:" + str2);
            int i2 = 0;
            while (true) {
            ...
            Log.d("wpdemo", "add 下载连接的个数 listTask.size:" + arrayList2.size());
        }
    }
}
