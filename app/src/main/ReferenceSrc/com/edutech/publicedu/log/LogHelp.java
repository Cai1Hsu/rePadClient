...
public class LogHelp {
    ...
    /* JADX DEBUG: TODO: convert one arg to string using `String.valueOf()`, args: [(wrap: int : 0x00ef: INVOKE  (r14v9 int A[REMOVE]) = 
      (wrap: org.apache.http.StatusLine : 0x00eb: INVOKE  (r14v8 org.apache.http.StatusLine A[REMOVE]) = (r3v0 'httpResponse' org.apache.http.HttpResponse A[D('httpResponse' org.apache.http.HttpResponse)]) type: INTERFACE call: org.apache.http.HttpResponse.getStatusLine():org.apache.http.StatusLine)
