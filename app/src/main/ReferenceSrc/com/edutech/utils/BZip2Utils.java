...
/* loaded from: classes.jar:com/edutech/utils/BZip2Utils.class */
public abstract class BZip2Utils {
    ...
    public static String StringEncodeToBase64(String str) throws Exception {
        return Base64.encodeToString(compress(str.getBytes("GBK")), 0);
    }
    ...
    public static void main(String[] strArr) throws Exception {
        new String(decompress(Base64.decode(Base64.encodeToString(compress("�й�".getBytes("GBK")), 0), 0)), "GBK");
    }
