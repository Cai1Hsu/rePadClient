...
public class DiscussActivity extends Activity {
    ...
    class DiscussAsync extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            String url = "http://" + DiscussActivity.this.ip + "/api/interaction";
            ...
            HttpGet get = DiscussActivity.this.HttpGet_Init(url);
            DefaultHttpClient client = new DefaultHttpClient();
            try {
                HttpResponse response = client.execute(get);
                String result = DiscussActivity.this.getJsonStringFromGZIP(response);
                ...
                if (status || errorNum == 0) {
                    ...
                    DiscussActivity.this.initDiscuss(data);
                    return "";
                }
                return "";
            } catch (Exception e) {
    ...
    class DiscussSubjectsAsync extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... arg0) {
            String url = "http://" + DiscussActivity.this.ip + "/api/subject/";
            HttpGet get = DiscussActivity.this.HttpGet_Init(url);
            DefaultHttpClient client = new DefaultHttpClient();
            try {
                HttpResponse response = client.execute(get);
    ...
    public void initDiscuss(JSONArray jarray) {
        JSONException e;
    ...
    class DiscussDetailsAsync extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... arg0) {
            String url = "http://" + DiscussActivity.this.ip + "/api/interaction/messageid/" + DiscussActivity.this.messageId;
            HttpGet get = DiscussActivity.this.HttpGet_Init(url);
            DefaultHttpClient client = new DefaultHttpClient();
            try {
                HttpResponse response = client.execute(get);
    ...
    class DiscussReplyAsync extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            HttpPost put = DiscussActivity.this.HttpPost_Init(url);
            Log.e(MagicNames.ANT_FILE_TYPE_URL, String.valueOf(url) + ",type:" + type + ",content:" + content);
            try {
                MultipartEntity entity = new MultipartEntity();
                entity.addPart("messageid", new StringBody(DiscussActivity.this.messageId));
    ...
    public HttpGet HttpGet_Init(String url) {
    ...
    public HttpPost HttpPost_Init(String url) {
