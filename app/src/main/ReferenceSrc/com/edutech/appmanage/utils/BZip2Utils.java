...
/* loaded from: classes.jar:com/edutech/appmanage/utils/BZip2Utils.class */
public abstract class BZip2Utils {
    ...
    public static String Base64DecodeToString(String str) throws Exception {
        Log.i("INFO", "base64:" + str);
        byte[] decode = Base64.decode(str, 0);
        StringBuffer stringBuffer = new StringBuffer();
        for (byte b : decode) {
            stringBuffer.append((int) b);
        }
        Log.i("INFO", "bb:" + stringBuffer.toString());
        return new String(decompress(decode), "GBK");
    }
