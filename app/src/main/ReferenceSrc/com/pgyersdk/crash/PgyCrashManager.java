...
public class PgyCrashManager {
    ...
    /* JADX DEBUG: Another duplicated slice has different insns count: {[INVOKE]}, finally: {[INVOKE, IF, CONST_STR, CONST_STR, INVOKE, AGET, INVOKE, CONST_STR, CONST_STR, INVOKE, IF] complete} */
