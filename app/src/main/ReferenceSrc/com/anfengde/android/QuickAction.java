...
public class QuickAction extends PopupWindows implements PopupWindow.OnDismissListener {
    ...
    static /* synthetic */ OnActionItemClickListener access$0(QuickAction quickAction) {
        return quickAction.mItemClickListener;
    }

    static /* synthetic */ void access$1(QuickAction quickAction, boolean z) {
        quickAction.mDidAction = z;
    }
    ...
    public void addActionItem(ActionItem action) {
        ...
        int pos = this.mChildPos;
        int actionId = action.getActionId();
        container.setOnClickListener(new AnonymousClass1(pos, actionId));
        container.setOnTouchListener(new AnonymousClass2());
    ...
    /* renamed from: com.anfengde.android.QuickAction$1 */
    /* loaded from: /home/caiyi/jadx/jadx-1.4.2/bin/classes.dex */
    class AnonymousClass1 implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (QuickAction.access$0(QuickAction.this) != null) {
                QuickAction.access$0(QuickAction.this).onItemClick(QuickAction.this, this.val$pos, this.val$actionId);
            }
            if (!QuickAction.this.getActionItem(this.val$pos).isSticky()) {
                QuickAction.access$1(QuickAction.this, true);
                QuickAction.this.dismiss();
            }
        }
    }

    /* renamed from: com.anfengde.android.QuickAction$2 */
    /* loaded from: /home/caiyi/jadx/jadx-1.4.2/bin/classes.dex */
