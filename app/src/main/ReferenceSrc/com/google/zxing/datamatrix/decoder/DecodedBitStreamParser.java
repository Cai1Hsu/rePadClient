...
final class DecodedBitStreamParser {
    ...
    private static final char[] C40_SHIFT2_SET_CHARS = {'!', '\"', '#', '$', '%', '&', '\'', '(', ')', '*', '+', ',', '-', FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX, ':', ';', '<', '=', '>', '?', '@', '[', IOUtils.DIR_SEPARATOR_WINDOWS, ']', '^', '_'};
    ...
    */
    static DecoderResult decode(byte[] bytes) throws FormatException {
        ...
        do {
            ...
            return new DecoderResult(bytes, sb, byteSegments, null);
        ...
        return new DecoderResult(bytes, sb2, byteSegments, null);
    }
