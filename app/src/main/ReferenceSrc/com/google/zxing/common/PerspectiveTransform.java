...
/* loaded from: classes.jar:com/google/zxing/common/PerspectiveTransform.class */
public final class PerspectiveTransform {
    ...
    public static PerspectiveTransform squareToQuadrilateral(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
        ...
        if (f9 == 0.0f && f10 == 0.0f) {
            perspectiveTransform = new PerspectiveTransform(f3 - f, f5 - f3, f, f4 - f2, f6 - f4, f2, 0.0f, 0.0f, 1.0f);
        } else {
            float f11 = f3 - f5;
            float f12 = f7 - f5;
            ...
            float f16 = ((f13 * f9) - (f12 * f10)) / f15;
            float f17 = ((f11 * f10) - (f13 * f14)) / f15;
            perspectiveTransform = new PerspectiveTransform((f3 - f) + (f16 * f3), (f7 - f) + (f17 * f7), f, (f16 * f4) + (f4 - f2), (f17 * f8) + (f8 - f2), f2, f16, f17, 1.0f);
        }
