...
/* loaded from: classes.jar:com/google/zxing/oned/EANManufacturerOrgSupport.class */
final class EANManufacturerOrgSupport {
    ...
    private void initIfNeeded() {
        synchronized (this) {
            if (this.ranges.isEmpty()) {
                ...
                add(new int[]{385}, "HR");
                add(new int[]{387}, "BA");
                add(new int[]{400, NNTPReply.POSTING_NOT_ALLOWED}, "DE");
                ...
                add(new int[]{478}, "UZ");
                add(new int[]{479}, "LK");
                add(new int[]{NNTPReply.AUTHENTICATION_REQUIRED}, "PH");
                add(new int[]{481}, "BY");
    ...
    String lookupCountryIdentifier(String str) {
        ...
        while (true) {
            ...
            if (parseInt <= i2) {
                str2 = this.countryIdentifiers.get(i);
                break;
            }
            i++;
        }
