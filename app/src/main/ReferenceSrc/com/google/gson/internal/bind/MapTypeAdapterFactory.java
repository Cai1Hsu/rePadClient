...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    static /* synthetic */ boolean access$000(MapTypeAdapterFactory x0) {
        return x0.complexMapKeySerialization;
    }
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public void write(JsonWriter out, Map<K, V> map) throws IOException {
            if (map == null) {
                out.nullValue();
            } else if (!MapTypeAdapterFactory.access$000(MapTypeAdapterFactory.this)) {
                out.beginObject();
