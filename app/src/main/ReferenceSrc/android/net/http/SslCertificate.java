...
/* loaded from: classes.jar:android/net/http/SslCertificate.class */
public class SslCertificate {

    /* loaded from: classes.jar:android/net/http/SslCertificate$DName.class */
    public class DName {
        public DName(String str) {
            SslCertificate.this = r5;
