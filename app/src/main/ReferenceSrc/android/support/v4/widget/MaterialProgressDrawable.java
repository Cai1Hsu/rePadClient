...
/* loaded from: classes.jar:android/support/v4/widget/MaterialProgressDrawable.class */
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /* loaded from: classes.jar:android/support/v4/widget/MaterialProgressDrawable$ProgressDrawableSize.class */
    public @interface ProgressDrawableSize {
    }

    /* loaded from: classes.jar:android/support/v4/widget/MaterialProgressDrawable$Ring.class */
    ...
    private void setupAnimators() {
        ...
        Animation animation = new Animation() { // from class: android.support.v4.widget.MaterialProgressDrawable.1
            ...
            public void applyTransformation(float f, Transformation transformation) {
                ...
                if (f > 0.5f) {
                    ring.setEndTrim(startingEndTrim + (MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((f - 0.5f) / 0.5f) * (MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc)));
                }
