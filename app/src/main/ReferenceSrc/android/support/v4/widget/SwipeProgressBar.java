...
/* loaded from: classes.jar:android/support/v4/widget/SwipeProgressBar.class */
final class SwipeProgressBar {
    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            long j2 = (currentAnimationTimeMillis - this.mStartTime) / FileUtils.FAT_FILE_TIMESTAMP_GRANULARITY;
            float f = ((float) ((currentAnimationTimeMillis - j) % FileUtils.FAT_FILE_TIMESTAMP_GRANULARITY)) / 20.0f;
            if (!this.mRunning) {
                if (currentAnimationTimeMillis - this.mFinishTime >= 1000) {
                    this.mFinishTime = 0L;
                    return;
                }
                float interpolation = (width / 2) * INTERPOLATOR.getInterpolation((((float) ((currentAnimationTimeMillis - this.mFinishTime) % 1000)) / 10.0f) / 100.0f);
                this.mClipRect.set(i2 - interpolation, 0.0f, i2 + interpolation, height);
