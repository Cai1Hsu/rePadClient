...
/* loaded from: classes.jar:android/support/v4/widget/PopupWindowCompat.class */
public final class PopupWindowCompat {
    static final PopupWindowImpl IMPL;

    /* loaded from: classes.jar:android/support/v4/widget/PopupWindowCompat$Api21PopupWindowImpl.class */
    ...
    /* loaded from: classes.jar:android/support/v4/widget/PopupWindowCompat$Api23PopupWindowImpl.class */
    ...
    /* loaded from: classes.jar:android/support/v4/widget/PopupWindowCompat$BasePopupWindowImpl.class */
    static class BasePopupWindowImpl implements PopupWindowImpl {
        ...
        public int getWindowLayoutType(PopupWindow popupWindow) {
            ...
            if (sGetWindowLayoutTypeMethod != null) {
                try {
                    intValue = ((Integer) sGetWindowLayoutTypeMethod.invoke(popupWindow, new Object[0])).intValue();
                } catch (Exception e2) {
                }
                return intValue;
            }
    ...
    /* loaded from: classes.jar:android/support/v4/widget/PopupWindowCompat$KitKatPopupWindowImpl.class */
    ...
    /* loaded from: classes.jar:android/support/v4/widget/PopupWindowCompat$PopupWindowImpl.class */
