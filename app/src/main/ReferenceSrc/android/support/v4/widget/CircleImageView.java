...
/* loaded from: classes.jar:android/support/v4/widget/CircleImageView.class */
class CircleImageView extends ImageView {
    ...
    /* loaded from: classes.jar:android/support/v4/widget/CircleImageView$OvalShadow.class */
    private class OvalShadow extends OvalShape {
        private RadialGradient mRadialGradient;
        private Paint mShadowPaint = new Paint();

        OvalShadow(int i) {
            CircleImageView.this = r5;
            r5.mShadowRadius = i;
