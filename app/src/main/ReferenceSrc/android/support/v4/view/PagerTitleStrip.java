...
@ViewPager.DecorView
/* loaded from: classes.jar:android/support/v4/view/PagerTitleStrip.class */
public class PagerTitleStrip extends ViewGroup {
    ...
    /* loaded from: classes.jar:android/support/v4/view/PagerTitleStrip$PageListener.class */
    ...
    /* loaded from: classes.jar:android/support/v4/view/PagerTitleStrip$PagerTitleStripImpl.class */
    interface PagerTitleStripImpl {
        void setSingleLineAllCaps(TextView textView);
    }

    /* loaded from: classes.jar:android/support/v4/view/PagerTitleStrip$PagerTitleStripImplBase.class */
    ...
    /* loaded from: classes.jar:android/support/v4/view/PagerTitleStrip$PagerTitleStripImplIcs.class */
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((getWidth() - getPaddingLeft()) - getPaddingRight()) * 0.8f)), ExploreByTouchHelper.INVALID_ID);
