...
@RequiresApi(11)
@TargetApi(11)
/* loaded from: classes.jar:android/support/v4/view/LayoutInflaterCompatHC.class */
class LayoutInflaterCompatHC {
    private static final String TAG = "LayoutInflaterCompatHC";
    private static boolean sCheckedField;
    private static Field sLayoutInflaterFactory2Field;

    /* loaded from: classes.jar:android/support/v4/view/LayoutInflaterCompatHC$FactoryWrapperHC.class */
