...
/* loaded from: classes.jar:android/support/v4/media/RatingCompat.class */
public final class RatingCompat implements Parcelable {
    ...
    /* loaded from: classes.jar:android/support/v4/media/RatingCompat$StarStyle.class */
    public @interface StarStyle {
    }

    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: classes.jar:android/support/v4/media/RatingCompat$Style.class */
    ...
    */
    ...
    public static RatingCompat newUnratedRating(int i) {
        ...
        switch (i) {
            ...
            case 5:
            case 6:
                ratingCompat = new RatingCompat(i, RATING_NOT_RATED);
                break;
            default:
                ratingCompat = null;
                break;
