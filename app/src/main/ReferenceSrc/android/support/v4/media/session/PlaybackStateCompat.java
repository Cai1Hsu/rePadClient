...
/* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat.class */
public final class PlaybackStateCompat implements Parcelable {
    ...
    /* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat$Actions.class */
    public @interface Actions {
    }

    /* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat$Builder.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat$CustomAction.class */
    public static final class CustomAction implements Parcelable {
        ...
        /* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat$CustomAction$Builder.class */
        public static final class Builder {
            private final String mAction;
            private Bundle mExtras;
            private final int mIcon;
        ...
        public static CustomAction fromCustomAction(Object obj) {
            ...
            if (obj == null || Build.VERSION.SDK_INT < 21) {
                ...
                CustomAction customAction2 = new CustomAction(PlaybackStateCompatApi21.CustomAction.getAction(obj), PlaybackStateCompatApi21.CustomAction.getName(obj), PlaybackStateCompatApi21.CustomAction.getIcon(obj), PlaybackStateCompatApi21.CustomAction.getExtras(obj));
    ...
    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat$ErrorCode.class */
    public @interface ErrorCode {
    }

    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat$MediaKeyAction.class */
    public @interface MediaKeyAction {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat$RepeatMode.class */
    public @interface RepeatMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    /* loaded from: classes.jar:android/support/v4/media/session/PlaybackStateCompat$State.class */
    ...
    public static PlaybackStateCompat fromPlaybackState(Object obj) {
        ...
        if (obj == null || Build.VERSION.SDK_INT < 21) {
            ...
            playbackStateCompat2.mStateObj = obj;
