...
/* loaded from: classes.jar:android/support/v4/media/session/IMediaSession.class */
public interface IMediaSession extends IInterface {

    /* loaded from: classes.jar:android/support/v4/media/session/IMediaSession$Stub.class */
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        /* loaded from: classes.jar:android/support/v4/media/session/IMediaSession$Stub$Proxy.class */
        ...
        /* JADX WARN: Type inference failed for: r0v8, types: [android.support.v4.media.session.IMediaSession] */
        public static IMediaSession asInterface(IBinder iBinder) {
            ...
            if (iBinder == null) {
                ...
                proxy = (queryLocalInterface == null || !(queryLocalInterface instanceof IMediaSession)) ? new Proxy(iBinder) : (IMediaSession) queryLocalInterface;
            }
            return proxy;
        }
