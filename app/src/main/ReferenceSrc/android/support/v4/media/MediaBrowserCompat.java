...
/* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat.class */
public final class MediaBrowserCompat {
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$CallbackHandler.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$ConnectionCallback.class */
    public static class ConnectionCallback {
        ConnectionCallbackInternal mConnectionCallbackInternal;
        final Object mConnectionCallbackObj;

        /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$ConnectionCallback$ConnectionCallbackInternal.class */
        ...
        /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$ConnectionCallback$StubApi21.class */
        private class StubApi21 implements MediaBrowserCompatApi21.ConnectionCallback {
            StubApi21() {
                ConnectionCallback.this = r4;
            }
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$ItemCallback.class */
    public static abstract class ItemCallback {
        final Object mItemCallbackObj;

        /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$ItemCallback$StubApi23.class */
        private class StubApi23 implements MediaBrowserCompatApi23.ItemCallback {
            StubApi23() {
                ItemCallback.this = r4;
            }
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$ItemReceiver.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaBrowserImpl.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaBrowserImplApi21.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaBrowserImplApi23.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaBrowserImplApi24.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase.class */
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection.class */
        private class MediaServiceConnection implements ServiceConnection {
            MediaServiceConnection() {
                MediaBrowserImplBase.this = r4;
            }
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaBrowserServiceCallbackImpl.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaItem.class */
    public static class MediaItem implements Parcelable {
        ...
        /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$MediaItem$Flags.class */
        ...
        public static MediaItem fromMediaItem(Object obj) {
            ...
            if (obj == null || Build.VERSION.SDK_INT < 21) {
                ...
                mediaItem = new MediaItem(MediaDescriptionCompat.fromMediaDescription(MediaBrowserCompatApi21.MediaItem.getDescription(obj)), MediaBrowserCompatApi21.MediaItem.getFlags(obj));
            }
            return mediaItem;
        }
        ...
        public static List<MediaItem> fromMediaItemList(List<?> list) {
            ...
            if (list != null && Build.VERSION.SDK_INT >= 21) {
                ...
                while (true) {
                    ...
                    arrayList2.add(fromMediaItem(it.next()));
                }
            } else {
                arrayList = null;
            }
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$SearchCallback.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$SearchResultReceiver.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$ServiceBinderWrapper.class */
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$Subscription.class */
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            ...
            while (true) {
                if (i >= this.mOptionsList.size()) {
                    ...
                    break;
                } else if (MediaBrowserCompatUtils.areSameOptions(this.mOptionsList.get(i), bundle)) {
                    subscriptionCallback = this.mCallbacks.get(i);
                    break;
                } else {
                    i++;
                }
    ...
    /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$SubscriptionCallback.class */
    public static abstract class SubscriptionCallback {
        private final Object mSubscriptionCallbackObj;
        WeakReference<Subscription> mSubscriptionRef;
        private final IBinder mToken;

        /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$SubscriptionCallback$StubApi21.class */
        private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            StubApi21() {
                SubscriptionCallback.this = r4;
            }
        ...
        /* loaded from: classes.jar:android/support/v4/media/MediaBrowserCompat$SubscriptionCallback$StubApi24.class */
