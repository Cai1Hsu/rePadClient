...
/* loaded from: classes.jar:android/support/v4/content/AsyncTaskLoader.class */
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    /* loaded from: classes.jar:android/support/v4/content/AsyncTaskLoader$LoadTask.class */
    final class LoadTask extends ModernAsyncTask<Void, Void, D> implements Runnable {
        private final CountDownLatch mDone = new CountDownLatch(1);
        boolean waiting;

        LoadTask() {
            AsyncTaskLoader.this = r6;
        }
        ...
        public D doInBackground(Void... voidArr) {
            D d;
            try {
                d = AsyncTaskLoader.this.onLoadInBackground();
