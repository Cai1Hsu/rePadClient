...
@RequiresApi(21)
@TargetApi(21)
/* loaded from: classes.jar:android/support/v4/graphics/drawable/DrawableCompatLollipop.class */
class DrawableCompatLollipop {
    ...
    public static Drawable wrapForTinting(Drawable drawable) {
        DrawableWrapperLollipop drawableWrapperLollipop = drawable;
        if (!(drawable instanceof TintAwareDrawable)) {
            drawableWrapperLollipop = new DrawableWrapperLollipop(drawable);
        }
        return drawableWrapperLollipop;
    }
}
