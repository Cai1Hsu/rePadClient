...
@RequiresApi(9)
@TargetApi(9)
/* loaded from: classes.jar:android/support/v4/graphics/drawable/DrawableWrapperGingerbread.class */
class DrawableWrapperGingerbread extends Drawable implements Drawable.Callback, DrawableWrapper, TintAwareDrawable {
    ...
    /* loaded from: classes.jar:android/support/v4/graphics/drawable/DrawableWrapperGingerbread$DrawableWrapperState.class */
    ...
    /* loaded from: classes.jar:android/support/v4/graphics/drawable/DrawableWrapperGingerbread$DrawableWrapperStateBase.class */
    ...
    public Drawable.ConstantState getConstantState() {
        ...
        if (this.mState == null || !this.mState.canConstantState()) {
            ...
            drawableWrapperState = this.mState;
        }
