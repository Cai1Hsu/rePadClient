...
@RequiresApi(20)
@TargetApi(20)
/* loaded from: classes.jar:android/support/v4/app/NotificationCompatApi20.class */
class NotificationCompatApi20 {

    /* loaded from: classes.jar:android/support/v4/app/NotificationCompatApi20$Builder.class */
    ...
    public static ArrayList<Parcelable> getParcelableArrayListForActions(NotificationCompatBase.Action[] actionArr) {
        ...
        if (actionArr != null) {
            ...
            while (true) {
                ...
                arrayList2.add(getActionFromActionCompat(actionArr[i]));
                i++;
            }
        } else {
            arrayList = null;
