...
/* loaded from: classes.jar:android/support/v4/app/TaskStackBuilder.class */
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    /* loaded from: classes.jar:android/support/v4/app/TaskStackBuilder$SupportParentable.class */
    public interface SupportParentable {
        Intent getSupportParentActivityIntent();
    }

    /* loaded from: classes.jar:android/support/v4/app/TaskStackBuilder$TaskStackBuilderImpl.class */
    interface TaskStackBuilderImpl {
        PendingIntent getPendingIntent(Context context, Intent[] intentArr, int i, int i2, Bundle bundle);
    }

    /* loaded from: classes.jar:android/support/v4/app/TaskStackBuilder$TaskStackBuilderImplBase.class */
    ...
    /* loaded from: classes.jar:android/support/v4/app/TaskStackBuilder$TaskStackBuilderImplHoneycomb.class */
    ...
    /* loaded from: classes.jar:android/support/v4/app/TaskStackBuilder$TaskStackBuilderImplJellybean.class */
    ...
    public TaskStackBuilder addParentStack(Activity activity) {
        ...
        if (intent2 != null) {
            ...
            ComponentName componentName = component;
            if (component == null) {
                componentName = intent2.resolveActivity(this.mSourceContext.getPackageManager());
            }
            addParentStack(componentName);
