...
/* loaded from: classes.jar:android/support/v4/app/DialogFragment.class */
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        if (!this.mShowsDialog) {
            ...
            if (this.mDialog != null) {
                ...
                layoutInflater = (LayoutInflater) this.mDialog.getContext().getSystemService("layout_inflater");
            } else {
                layoutInflater = (LayoutInflater) this.mHost.getContext().getSystemService("layout_inflater");
            }
        }
