...
/* loaded from: classes.jar:android/support/v4/util/MapCollections.class */
abstract class MapCollections<K, V> {
    MapCollections<K, V>.EntrySet mEntrySet;
    MapCollections<K, V>.KeySet mKeySet;
    MapCollections<K, V>.ValuesCollection mValues;

    /* loaded from: classes.jar:android/support/v4/util/MapCollections$ArrayIterator.class */
    final class ArrayIterator<T> implements Iterator<T> {
        ...
        ArrayIterator(int i) {
            MapCollections.this = r4;
            this.mOffset = i;
            this.mSize = r4.colGetSize();
        }
    ...
    /* loaded from: classes.jar:android/support/v4/util/MapCollections$EntrySet.class */
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            ...
            if (obj instanceof Map.Entry) {
                ...
                if (colIndexOfKey >= 0) {
                    z = ContainerHelpers.equal(MapCollections.this.colGetEntry(colIndexOfKey, 1), entry.getValue());
                }
            }
            return z;
        }
    ...
    /* loaded from: classes.jar:android/support/v4/util/MapCollections$KeySet.class */
    ...
    /* loaded from: classes.jar:android/support/v4/util/MapCollections$MapIterator.class */
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        MapIterator() {
            MapCollections.this = r5;
            this.mEnd = r5.colGetSize() - 1;
        }
    ...
    /* loaded from: classes.jar:android/support/v4/util/MapCollections$ValuesCollection.class */
