...
/* loaded from: classes.jar:android/support/v4/provider/DocumentFile.class */
public abstract class DocumentFile {
    ...
    public static DocumentFile fromSingleUri(Context context, Uri uri) {
        return Build.VERSION.SDK_INT >= 19 ? new SingleDocumentFile(null, context, uri) : null;
    }

    public static DocumentFile fromTreeUri(Context context, Uri uri) {
        return Build.VERSION.SDK_INT >= 21 ? new TreeDocumentFile(null, context, DocumentsContractApi21.prepareTreeUri(uri)) : null;
    }

    public static boolean isDocumentUri(Context context, Uri uri) {
        return Build.VERSION.SDK_INT >= 19 ? DocumentsContractApi19.isDocumentUri(context, uri) : false;
    }
