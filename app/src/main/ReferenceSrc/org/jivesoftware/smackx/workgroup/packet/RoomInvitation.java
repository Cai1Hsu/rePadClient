...
/* loaded from: classes.jar:org/jivesoftware/smackx/workgroup/packet/RoomInvitation.class */
public class RoomInvitation implements PacketExtension {
    ...
    /* loaded from: classes.jar:org/jivesoftware/smackx/workgroup/packet/RoomInvitation$Provider.class */
    ...
    /* loaded from: classes.jar:org/jivesoftware/smackx/workgroup/packet/RoomInvitation$Type.class */
    public enum Type {
        user,
        queue,
        workgroup
