...
/* loaded from: classes.jar:org/jivesoftware/smackx/pubsub/ConfigureForm.class */
public class ConfigureForm extends Form {
    ...
    private String getFieldValue(ConfigureNodeFields configureNodeFields) {
        ...
        return field.getValues().hasNext() ? field.getValues().next() : null;
    }
    ...
    private static boolean parseBoolean(String str) {
        return LogHelp.TYPE_GUIDANCE.equals(str) || "true".equals(str);
    }
