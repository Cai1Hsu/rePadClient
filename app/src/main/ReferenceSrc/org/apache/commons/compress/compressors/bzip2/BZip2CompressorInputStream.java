...
/* loaded from: classes.jar:org/apache/commons/compress/compressors/bzip2/BZip2CompressorInputStream.class */
public class BZip2CompressorInputStream extends CompressorInputStream implements BZip2Constants {
    ...
    /* loaded from: classes.jar:org/apache/commons/compress/compressors/bzip2/BZip2CompressorInputStream$Data.class */
    ...
    private boolean init(boolean z) throws IOException {
        ...
        if (read == -1 && !z) {
            z2 = false;
        } else if (read != 66 || read2 != 90 || read3 != 104) {
