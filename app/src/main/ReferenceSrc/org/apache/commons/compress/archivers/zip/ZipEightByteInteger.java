...
/* loaded from: classes.jar:org/apache/commons/compress/archivers/zip/ZipEightByteInteger.class */
public final class ZipEightByteInteger {
    ...
    public static byte[] getBytes(BigInteger bigInteger) {
        ...
        byte[] bArr = {(byte) (255 & longValue), (byte) ((65280 & longValue) >> 8), (byte) ((16711680 & longValue) >> 16), (byte) ((BYTE_3_MASK & longValue) >> 24), (byte) ((BYTE_4_MASK & longValue) >> 32), (byte) ((BYTE_5_MASK & longValue) >> 40), (byte) ((BYTE_6_MASK & longValue) >> 48), (byte) ((BYTE_7_MASK & longValue) >> 56)};
        if (bigInteger.testBit(LEFTMOST_BIT_SHIFT)) {
    ...
    public static BigInteger getValue(byte[] bArr, int i) {
        BigInteger valueOf = BigInteger.valueOf(((bArr[i + 7] << 56) & BYTE_7_MASK) + ((bArr[i + 6] << 48) & BYTE_6_MASK) + ((bArr[i + 5] << 40) & BYTE_5_MASK) + ((bArr[i + 4] << 32) & BYTE_4_MASK) + ((bArr[i + 3] << 24) & BYTE_3_MASK) + ((bArr[i + 2] << 16) & 16711680) + ((bArr[i + 1] << 8) & 65280) + (bArr[i] & 255));
        BigInteger bigInteger = valueOf;
        if ((bArr[i + 7] & LEFTMOST_BIT) == LEFTMOST_BIT) {
            bigInteger = valueOf.setBit(LEFTMOST_BIT_SHIFT);
        }
        return bigInteger;
    }

    public boolean equals(Object obj) {
        return (obj == null || !(obj instanceof ZipEightByteInteger)) ? false : this.value.equals(((ZipEightByteInteger) obj).getValue());
    }
