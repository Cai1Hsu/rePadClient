...
/* loaded from: classes.jar:org/apache/commons/io/DirectoryWalker.class */
public abstract class DirectoryWalker<T> {
    private final int depthLimit;
    private final FileFilter filter;

    /* loaded from: classes.jar:org/apache/commons/io/DirectoryWalker$CancelException.class */
