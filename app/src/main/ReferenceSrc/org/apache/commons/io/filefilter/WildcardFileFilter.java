...
/* loaded from: classes.jar:org/apache/commons/io/filefilter/WildcardFileFilter.class */
    ...
    public boolean accept(File file) {
        ...
        while (true) {
            if (i >= length) {
                z = false;
                break;
            } else if (FilenameUtils.wildcardMatch(name, strArr[i], this.caseSensitivity)) {
                z = true;
                break;
            } else {
                i++;
    ...
    public boolean accept(File file, String str) {
        ...
        while (true) {
            if (i >= length) {
                z = false;
                break;
            } else if (FilenameUtils.wildcardMatch(str, strArr[i], this.caseSensitivity)) {
                z = true;
                break;
            } else {
                i++;
