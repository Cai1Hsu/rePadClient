...
@Deprecated
/* loaded from: classes.jar:org/apache/commons/codec/language/DoubleMetaphone.class */
public class DoubleMetaphone implements StringEncoder {
    protected int maxCodeLen;

    /* loaded from: classes.jar:org/apache/commons/codec/language/DoubleMetaphone$DoubleMetaphoneResult.class */
    public class DoubleMetaphoneResult {
        public DoubleMetaphoneResult(int i) {
            DoubleMetaphone.this = r5;
