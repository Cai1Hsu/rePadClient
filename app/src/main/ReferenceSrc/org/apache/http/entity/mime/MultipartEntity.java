...
/* loaded from: classes.jar:org/apache/http/entity/mime/MultipartEntity.class */
public class MultipartEntity implements HttpEntity {
    ...
    public MultipartEntity(HttpMultipartMode httpMultipartMode, String str, Charset charset) {
        ...
        this.multipart = new HttpMultipart("form-data", charset, generateBoundary, httpMultipartMode == null ? HttpMultipartMode.STRICT : httpMultipartMode);
        this.contentType = new BasicHeader("Content-Type", generateContentType(generateBoundary, charset));
        this.dirty = true;
    }
    ...
    public boolean isRepeatable() {
        ...
        while (true) {
            if (!it.hasNext()) {
                z = true;
                break;
            } else if (it.next().getBody().getContentLength() < 0) {
                z = false;
                break;
            }
        }
