...
/* loaded from: classes.jar:org/apache/tools/zip/ZipEncodingHelper.class */
abstract class ZipEncodingHelper {
    ...
    /* loaded from: classes.jar:org/apache/tools/zip/ZipEncodingHelper$SimpleEncodingHolder.class */
    ...
    static ZipEncoding getZipEncoding(String str) {
        ...
        if (isUTF8(str)) {
            ...
            SimpleEncodingHolder simpleEncodingHolder = (SimpleEncodingHolder) simpleEncodings.get(str);
