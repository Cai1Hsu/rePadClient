...
.method public isSelected(Lorg/apache/tools/ant/types/Resource;)Z
    ...
    .line 42
    sget-object v1, Lorg/apache/tools/ant/types/selectors/ReadableSelector;->class$org$apache$tools$ant$types$resources$FileProvider:Ljava/lang/Class;

    if-nez v1, :cond_0

    const-string/jumbo v1, "org.apache.tools.ant.types.resources.FileProvider"

    invoke-static {v1}, Lorg/apache/tools/ant/types/selectors/ReadableSelector;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v1

    sput-object v1, Lorg/apache/tools/ant/types/selectors/ReadableSelector;->class$org$apache$tools$ant$types$resources$FileProvider:Ljava/lang/Class;
    ...
    invoke-virtual {p0, v2, v2, v1}, Lorg/apache/tools/ant/types/selectors/ReadableSelector;->isSelected(Ljava/io/File;Ljava/lang/String;Ljava/io/File;)Z
