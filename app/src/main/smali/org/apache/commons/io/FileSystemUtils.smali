...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v5, "os.name not found"
    ...
    const-string/jumbo v4, "digital unix"
    ...
    const-string/jumbo v4, "mac os x"
...
.method freeSpaceOS(Ljava/lang/String;IZJ)J
    ...
    const-string/jumbo v1, "Exception caught when determining operating system"
    ...
    const-string/jumbo v1, "Unsupported operating system"
...
.method freeSpaceUnix(Ljava/lang/String;ZZJ)J
    ...
    const-string/jumbo v8, "Path must not be empty"
    ...
    const-string/jumbo v9, "Command line \'"
    ...
    const-string/jumbo v9, "\' did not return info as expected "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string/jumbo v9, "for path \'"
    ...
    const-string/jumbo v9, "\'- response was "
    ...
    const-string/jumbo v9, "\' did not return data as expected "
    ...
    const-string/jumbo v9, "\'- check path is valid"
...
.method freeSpaceWindows(Ljava/lang/String;J)J
    ...
    const-string/jumbo v6, "Command line \'dir /-c\' did not return any info for path \'"
...
.method parseBytes(Ljava/lang/String;Ljava/lang/String;)J
    ...
    const-string/jumbo v5, "Command line \'"
    ...
    const-string/jumbo v5, "\' did not find free space in response "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string/jumbo v5, "for path \'"
    ...
    const-string/jumbo v5, "\'- check path is valid"
    ...
    const-string/jumbo v5, "\' did not return numeric data as expected "
...
.method parseDir(Ljava/lang/String;Ljava/lang/String;)J
    ...
    const-string/jumbo v9, "Command line \'dir /-c\' did not return valid info for path \'"
...
.method performCommand([Ljava/lang/String;IJ)Ljava/util/List;
    ...
    const-string/jumbo v14, "Command line returned OS error code \'"
    ...
    const-string/jumbo v14, "\' for command "
    ...
    const-string/jumbo v14, "Command line threw an InterruptedException for command "
    ...
    const-string/jumbo v14, "Command line did not return any info for command "
