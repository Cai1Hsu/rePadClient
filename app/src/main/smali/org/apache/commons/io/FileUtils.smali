...
.method public static checksum(Ljava/io/File;Ljava/util/zip/Checksum;)Ljava/util/zip/Checksum;
    ...
    const-string/jumbo v3, "Checksums can\'t be computed on directories"
...
.method public static copyDirectory(Ljava/io/File;Ljava/io/File;Ljava/io/FileFilter;Z)V
    ...
    const-string/jumbo v8, "Source must not be null"
    ...
    const-string/jumbo v8, "Destination must not be null"
    ...
    const-string/jumbo v9, "\' exists but is not a directory"
    ...
    const-string/jumbo v9, "\' and destination \'"
    ...
    const-string/jumbo v9, "\' are the same"
...
.method public static directoryContains(Ljava/io/File;Ljava/io/File;)Z
    ...
    const-string/jumbo v3, "Directory must not be null"
...
.method private static doCopyDirectory(Ljava/io/File;Ljava/io/File;Ljava/io/FileFilter;ZLjava/util/List;)V
    ...
    const-string/jumbo v8, "\' exists but is not a directory"
    ...
    const-string/jumbo v8, "\' directory cannot be created"
    ...
    const-string/jumbo v8, "\' cannot be written to"
...
.method private static doCopyFile(Ljava/io/File;Ljava/io/File;Z)V
    ...
    const-string/jumbo v16, "\' exists but is a directory"
    ...
    const-string/jumbo v16, "Failed to copy full contents from \'"
...
.method public static varargs getFile(Ljava/io/File;[Ljava/lang/String;)Ljava/io/File;
    ...
    const-string/jumbo v7, "directorydirectory must not be null"
    ...
    const-string/jumbo v7, "names must not be null"
...
.method public static moveDirectory(Ljava/io/File;Ljava/io/File;)V
    ...
    const-string/jumbo v3, "Cannot move directory: "
    ...
    const-string/jumbo v3, " to a subdirectory of itself: "
    ...
    const-string/jumbo v3, "Failed to delete original directory \'"
...
.method public static touch(Ljava/io/File;)V
    ...
    const-string/jumbo v4, "Unable to set the last modification time for "
