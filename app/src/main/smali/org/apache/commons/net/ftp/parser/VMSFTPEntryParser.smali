...
.method public constructor <init>(Lorg/apache/commons/net/ftp/FTPClientConfig;)V
    ...
    .prologue
    .line 95
    const-string/jumbo v0, "(.*;[0-9]+)\\s*(\\d+)/\\d+\\s*(\\S+)\\s+(\\S+)\\s+\\[(([0-9$A-Za-z_]+)|([0-9$A-Za-z_]+),([0-9$a-zA-Z_]+))\\]?\\s*\\([a-zA-Z]*,([a-zA-Z]*),([a-zA-Z]*),([a-zA-Z]*)\\)"
...
.method protected getDefaultConfiguration()Lorg/apache/commons/net/ftp/FTPClientConfig;
    ...
    const-string/jumbo v2, "d-MMM-yyyy HH:mm:ss"
