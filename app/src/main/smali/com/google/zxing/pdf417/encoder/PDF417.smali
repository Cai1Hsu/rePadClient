...
.method private static getNumberOfDataCodewords(III)I
    ...
    .line 613
    .local v0, "k":I
    invoke-static {p0, v0, p2}, Lcom/google/zxing/pdf417/encoder/PDF417;->getNumberOfRows(III)I
...
.method private static getNumberOfRows(III)I
    ...
    const-string/jumbo v2, "The message doesn\'t fit in the configured symbol size. The resultant number of rows for this barcode exceeds 90. Please increase the number of columns or decrease the error correction level to reduce the number of rows."
    ...
    const-string/jumbo v2, "The message is too short for the configured symbol size. The resultant number of rows is less than 3. Please decrease the number of columns or increase the error correction level to increase the number of rows."
