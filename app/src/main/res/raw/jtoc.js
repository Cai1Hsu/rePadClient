...
function getChapter(chapterTitle,level,i,currentChapterIndex){
	...
	//add kao 20130805
	$("#afd_BTContent").append("<li id='afd_chapterborder'></li>");
   	if (i%2 ==0){
		$("#afd_chapter"+i).css("background","#ececec");
		}else if(i%2 ==1){
		$("#afd_chapter"+i).css("background","#ffffff");	
			}
    ...
    if (currentChapterIndex==i){
		...
		$("#afd_chapter"+i).css("background","#2b9b13");
...
function getBookmark(bookmark,i){
	...
	$("#afd_BTContent").append("<li id='afd_chapterborder'></li>");
	if (i%2 ==0){
		$("#afd_bookmark"+i).css("background","#ececec");
		}else if(i%2 ==1){
		$("#afd_bookmark"+i).css("background","#ffffff");	
			}
...
function addBookmarkListener(i){
	...
	$("#afd_bookmark"+i).css("background","#2b9b13");
